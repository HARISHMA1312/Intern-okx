...
export default function BlackCol() {
  return (
    <div className='blackk'>
            ...
            <img src='https://www.okx.com/cdn/assets/imgs/243/5AD5609D76BF42F4.png?x-oss-process=image/format,webp/resize,w_600,h_680' alt='Mobile' className='mobile-img'/>
            <div className='tel'>
              <h6>Join our Telegram group</h6>
              <p>
